with open('text.txt', 'r', encoding='utf-8') as file: # Открываем файл 'text.txt' в режиме чтения с кодировкой utf-8. 
    text = file.read() # Читаем содержимое файла и сохраняем его в переменную 'text'.
words = text.split() # Разбиваем строку 'text' на отдельные слова, используя пробелы в качестве разделителей.
